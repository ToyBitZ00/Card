...
public class TestCard {
    public static void main(String[] args) {
        ...
        fCardRandomOpp = (int) (Math.random() * 100 % 13 + 1);
        sCardRandomOpp = (int) (Math.random() * 100 % 13 + 1);

        System.out.println("\nThe AI's first card suit is: " + randomSuit1);
        System.out.println("The Ai's first card number is: " + fCardRandomOpp);
        System.out.println("The AI's second card suit is: " + randomSuit2);
        System.out.println("The AI's second card number is: " + sCardRandomOpp);
